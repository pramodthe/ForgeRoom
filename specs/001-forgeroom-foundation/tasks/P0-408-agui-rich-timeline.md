...
- [ ] Mount one browser reducer per coworker thread, merge by channel sequence, and consume the single channel/system state lane without allowing a coworker reducer to overwrite it.
...
- [ ] Logical-turn busy state survives frontend-tool/HITL wire-run gaps.
