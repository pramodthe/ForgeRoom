...
- Local report (2026-08-29): expanded `pnpm test:security` release runner under Node 22.20.0 — 82 files / 443 tests passed with zero skips across contracts, domain, DB, orchestration, adapters, API isolation/archive/audit paths, real Sharp image hardening, ZIP credential screening, web trusted-host UI, controlled components and decompressed-trace redaction.
