...
- Direct resume authorization is covered by `apps/api/src/ag-ui/routes.test.ts`, `packages/orchestration/src/pause-resume.test.ts`, and the database PauseGroup/PauseResume integration suites.
