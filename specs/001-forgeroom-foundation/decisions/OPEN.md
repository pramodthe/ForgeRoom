...
| OD-009 | Exact demo task and synthetic fixture | P0-105, P0-505 | demo Task title/transition candidate; provider issue `pramodthe/Hi-Tuto#10` + label verified | Reset twice and complete manual path |
...
| OD-012 | Conversational coworker draft prompt/expected permission preview and instruction-only Save-as-skill fixture | P0-213/P0-318 onward | prompt frozen; model `openai/gpt-5-4-mini`; read-only exactDiff from Composio catalogue; Save-as-skill Run still open | Exact read-only draft diff (fixture); UI confirm/stale probe + skill Run binding remain |
